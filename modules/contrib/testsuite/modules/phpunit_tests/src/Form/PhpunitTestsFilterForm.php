 ...
 * @internal
 */
class PhpunitTestsFilterForm extends FormBase {
  use BaseTrait;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $session_filters = $this->getRequest()->getSession()->get('phpunit_tests_overview_filter', []);
    ...
    if ($modules = $this->phpunitTestsRepositoryService->getModules()) {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->getRequest()->getSession()->set('phpunit_tests_overview_filter', $session_filters);
