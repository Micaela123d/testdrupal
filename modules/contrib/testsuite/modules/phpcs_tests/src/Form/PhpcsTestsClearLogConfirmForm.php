 ...
 * @internal
 */
class PhpcsTestsClearLogConfirmForm extends ConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('phpcs_tests.phpcs_report');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->connection->truncate('phpcs_test_item')->execute();
